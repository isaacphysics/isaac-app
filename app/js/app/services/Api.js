    ...
    let Api = function ApiConstructor($resource, urlPrefix, $http, subject) {
        ...
        this.getQuestionsResource = function() {
            return $resource(urlPrefix + "/pages/questions", {}, {
                'query': {
                    method: 'GET', isArray: false, cancellable : true, params: {searchString:"@searchString", tags:"@tags", levels:"@levels", fasttrack: "@fasttrack", start_index:"@startIndex", limit:"@limit"}
                }
            })
        };

	...
	return ["api", "$sce", function(api, $sce) {
		...
		return {
			...
			link: function(scope, element, _attrs) {
				...
				let embedUrl = scope.doc.src.replace('youtu.be/', 'www.youtube.com/watch?v=').replace('watch?v=','embed/').replace("youtube.com", "youtube-nocookie.com");
				scope.videoSrc = $sce.trustAsResourceUrl(embedUrl + "?enablejsapi=1&rel=0&fs=1&modestbranding=1&origin=" + window.location.origin);
				YT.ready(function() {
					setTimeout(function() {

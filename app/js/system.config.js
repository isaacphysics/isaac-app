...
System.config({
    ...
    map: {
        ...
        "angulartics": 'bower_components/angulartics/dist/angulartics.min.js',
        ...
        "p5": "js/lib/p5.min.js",
        "socket.io-client": 'bower_components/socket.io-client/dist/socket.io.js'
    },
    ...
    meta: {
        ...
        "angulartics-google-analytics": { deps: ["angulartics"], format: 'global'},
        ...
        "p5": { format: 'global' },
        "socket.io-client": {format: 'global'}
    }
});
